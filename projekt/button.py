...
class Button:
    ...
    def draw(self):
        ...
        button_color = self.hover_color if self.rect.collidepoint(mouse_x, mouse_y) else self.color
        
        pygame.draw.rect(self.screen, button_color, self.rect)
        pygame.draw.rect(self.screen, (0, 0, 0), self.rect, 2)  # Czarna ramka dla efektu
